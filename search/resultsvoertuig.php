...
$searchterm = mysqli_real_escape_string($link, $_GET['search_voertuig']);
$searchterm = htmlspecialchars($searchterm);

$raw_results = mysqli_query($link,"SELECT * FROM tbl_voertuig WHERE (`merk` LIKE '%".$searchterm."%') OR (`model` LIKE '%".$searchterm."%') OR (`kentekennummer` LIKE '%".$searchterm."%') OR (`categorie` LIKE '%".$searchterm."%') OR (`bouwjaar` LIKE '%".$searchterm."%')") or die(mysqli_error($link));
