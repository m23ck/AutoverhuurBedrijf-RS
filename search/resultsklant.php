...
$searchterm = mysqli_real_escape_string($link, $_GET['search_klant']);
$searchterm = htmlspecialchars($searchterm);

$raw_results = mysqli_query($link,"SELECT * FROM tbl_klanten WHERE (`naam` LIKE '%".$searchterm."%') OR (`voornaam` LIKE '%".$searchterm."%') OR (`bedrijf` LIKE '%".$searchterm."%')") or die(mysqli_error($link));
